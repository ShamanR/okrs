...
- в актуальном периоде возвращаются только активные команды;
- soft-deleted команды скрыты из актуального периода;
- в историческом периоде команда видна только если в выбранном периоде у неё есть OKR/goals;
