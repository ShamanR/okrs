...
Охват влияет на все секции обзора одинаково: статусы, качество, балансы целей и график прогресса. Легаси admin-only `GET /api/v1/admin/periods/{periodID}/overview` (весь тенант) сохранён для админ-модалки. Массовые операции над статусами остаются admin-only и в публичной странице скрыты для не-админов.
