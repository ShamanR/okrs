...
- для актуального периода — только активные команды;
- для исторического периода — только команды, у которых есть goals/OKR в этом периоде;
- soft-deleted команды не должны попадать в ответ актуального периода;
- soft-deleted команды могут возвращаться для исторического периода, если у них есть goals в выбранном периоде.
