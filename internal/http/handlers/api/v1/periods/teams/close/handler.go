// Package close serves the bulk period-status endpoint under its URI segment.
package close
...
func (h *Handler) Post(w http.ResponseWriter, r *http.Request) {
	bulkstatus.RunScoped(w, r, h.periodUC, h.teams, h.leads, domain.TeamPeriodStatusClosed)
}
