// Package moveup serves POST /api/v1/goals/{goalID}/move-up.
package moveup
...
// Post moves the goal up within the viewing team's board. The body is shared with
...
func RegisterRoutes(r chi.Router, h *Handler) {
	r.Post("/api/v1/goals/{goalID}/move-up", h.Post)
}
