...
func (h *Handler) handleTeamOverview(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		writeError(w, http.StatusInternalServerError, "INTERNAL", "failed to load team overview", nil)
		return
	}
	writeJSON(w, http.StatusOK, mapTeamOverviewResponse(period, overview))
}
