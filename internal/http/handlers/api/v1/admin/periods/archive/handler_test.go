...
// Тесты переехали из пакета admin вместе с обработчиком POST /api/v1/admin/periods/{periodID}/archive.
...
func newAdminHandlerWithPeriod(_ *testing.T, p domain.Period) *Handler {
	return New(periodsvc.New(&fakePeriodRepo{period: p}))
}
