// Package boolean serves POST /api/v1/krs/{krID}/progress/boolean.
package boolean
...
func (h *Handler) Post(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.uc.UpdateProgressBoolean(r.Context(), scope, krID, req.Done, auth.UserIDFromContext(r.Context())); err != nil {
