// Package movedown serves POST /api/v1/krs/{krID}/move-down.
package movedown
...
// Post moves the key result down within its goal. The body is shared with the opposite
...
func RegisterRoutes(r chi.Router, h *Handler) {
	r.Post("/api/v1/krs/{krID}/move-down", h.Post)
}
