...
-- ----------------------------------------------------------------
INSERT INTO
    tenants (id, slug, name) OVERRIDING SYSTEM VALUE
...
ALTER TABLE team_period_statuses
...
-- ----------------------------------------------------------------
TRUNCATE TABLE kr_project_stages,
kr_boolean_meta,
key_result_notes,
goal_comments,
key_results,
...
VALUES
    ...
    (
        ...
        NULL,
        '',
        'Кластер инженерных команд: платформа, сервисы и продуктовая разработка.',
        NOW(),
        NOW()
    ),
    (
    ...
    (
        ...
        5,
        '',
        'Ядро платформы: backend, инфраструктура и данные продуктов.',
        NOW(),
        NOW()
    ),
    (
    ...
    (
        ...
        5,
        '',
        'Продуктовые сервисы платформы: медиа, финансы и интеграции.',
        NOW(),
        NOW()
    ),
...
VALUES
    ...
    (
        ...
        3,
        1,
        'Обеспечить 99.9% uptime DWH пайплайнов',
        '',
        'P0',
        40,
        'Discovery',
    ...
    (
        ...
        3,
        1,
        'Перевести DWH на ClickHouse 24',
        '',
        'P0',
        25,
        'Discovery',
    ...
    (
        ...
        4,
        4,
        'Система мониторинга как основной источник информации о инцидентах',
        '',
        'P0',
        25,
        'Discovery',
    ...
    (
        ...
        4,
        4,
        'Аналитика и исследование инцидентов на регулярной основе',
        '',
        'P1',
        35,
        'Delivery',
    ...
    (
        ...
        4,
        4,
        'Запуск и обеспечение функционирования режима оперативного дежурства 24/7',
        '',
        'P0',
        20,
        'Discovery',
    ...
    (
        ...
        4,
        4,
        'Внедрить IaC для всей инфраструктуры',
        '',
        'P1',
        50,
        'Delivery',
    ...
    (
        ...
        23,
        5,
        'Подключить funsun к сетке для опробирования полного цикла сетки',
        '',
        'P0',
        20,
        'Discovery',
...
-- ----------------------------------------------------------------
INSERT INTO
    team_period_statuses (team_id, period_id, status)
VALUES (2, 4, 'in_progress'),
    (3, 1, 'closed'),
    (4, 4, 'in_progress'),
    (5, 4, 'forming'),
    (21, 4, 'ready'),
...
VALUES
    ...
    (
        7,
        8,
        'Внедрен регламент дежурств во все юниты',
    ...
    (
        8,
        8,
        'Внедрены инструкции для дежурных инженеров',
    ...
    (
        9,
        8,
        'Каллендарь дежурств внедрен в 5 команд',
    ...
    (
        10,
        9,
        'Инцидент менеджмент для P0\P1 автоматизирован',
    ...
    (
        11,
        9,
        'Система мониторинга покрывает 75% критических алертов',
    ...
    (
        14,
        9,
        'Автоматизация протестирована на тестовых инцидентах',
    ...
    (
        15,
        10,
        'Создана регулярная встреча по аналитике инцидентов за прошедший период',
    ...
    (
        16,
        10,
        'Создан план по работе с историческими данными по инцидентам',
    ...
    (
        18,
        10,
        'Реализован процесс подсчета потерь по инцидентам',
        '',
        25,
        'BOOLEAN',
        4,
    ...
    (
        47,
        30,
        '100% трафика на сайте крутится через сетку',
    ...
    (
        48,
        30,
        'Есть техническая возможность видеть баннер',
        '',
        50,
        'PROJECT',
        2,
    ...
    (
        ...
        32,
        'Миграция на HTTP/2',
        'Переключить все внутренние вызовы',
        20,
        'BOOLEAN',
        3,
        NOW(),
    ...
    (
        55,
        34,
        'Развернуть Confluence/Notion',
        'Setup и настройка инструмента',
        30,
        'BOOLEAN',
        1,
        NOW(),
    ...
    (
        57,
        37,
        'Перевести prod окружение на Terraform',
        'Все сервисы prod',
        60,
        'NUMERICAL',
        1,
    ...
    (
        58,
        37,
        'Написать модули для баз данных',
        'RDS, Redis модули',
        25,
        'PROJECT',
        2,
    ...
    (
        59,
        38,
        'Настроить runbooks для топ-5 инцидентов',
        'По каждому типу инцидента',
        50,
        'PROJECT',
        1,
        NOW(),
    ...
    (
        60,
        38,
        'Среднее время реакции on-call',
        'Текущее: 45 мин → Цель: 30 мин',
        50,
        'NUMERICAL',
        2,
        NOW(),
...
-- ----------------------------------------------------------------
INSERT INTO
    kr_boolean_meta (key_result_id, is_done)
VALUES (7, false),
    (8, true),
    (14, false),
    (15, false),
...
SET
    ...
    unit = v.unit
FROM (
        VALUES (9, 0, 5, 2, 'шт'), (11, 10, 75, 50, '%'), (45, 0, 100, 51, '%'), (46, 0, 100, 10, '%'), (47, 0, 100, 0, '%'), (53, 0, 100, 0, '%'), (54, 0, 100, 0, '%'), (57, 0, 100, 0, '%'), (42, 0, 100, 50, '%'), (50, 450, 200, 450, 'мс'), (51, 380, 200, 380, 'мс'), (60, 45, 30, 45, 'мин')
    ) AS v (
        kr_id, start, target, current, unit
    )
WHERE
    key_results.id = v.kr_id;
...
VALUES
    ...
    (
        19,
        10,
        'Создает тикет инцидента в заданной системе (Jira, Youtrack и т.п.) с предзаполненными полями',
        33,
        true,
        1
    ),
    (
        20,
        10,
        'Создает отдельный чат для коммуникации по инциденту',
        33,
        true,
        2
    ),
    (
        21,
        10,
        'Автоматически приглашает в созданный чат рабочую группу по данному типу инцидентов',
        34,
        true,
        3
    ),
    ...
    (
        59,
        48,
        'настроен кабинет под все виды пользователей',
        30,
        false,
        2
    ),
    (
        60,
        48,
        'подписан договор с внешним сайтом',
        50,
        false,
        3
    );
...
VALUES (
        5,
        32,
        'Обновление по задаче выполнено.',
        1,
        NOW()
    ),
    (
...
VALUES (
        ...
        NULL,
        '',
        'Департамент: каталог целей Y26 Q1.',
        NOW(),
        NOW()
    ),
    (
        ...
        100,
        '',
        'Кластер инженерных команд департамента.',
        NOW(),
        NOW()
    ),
    (
        ...
        101,
        '',
        'Ядро платформы: backend, инфраструктура и данные.',
        NOW(),
        NOW()
    ),
    (
        ...
        102,
        'Дмитрий Петров',
        'Стандарты кода и процессов для Backend и QA команд.',
        NOW(),
        NOW()
    ),
    (
...
-- Goals → Y2026 (годовые цели департамента)
INSERT INTO
    goals (
        id,
        team_id,
...
VALUES
    ...
    (
        ...
        2,
        'Покрыть 80% кода тестами',
        'Повысить надёжность через автоматизацию',
        'P1',
        30,
        'Delivery',
        'QUALITY',
    ...
    (
        ...
        2,
        'Запустить портал документации',
        'Единое место для архитектурных решений',
        'P2',
        20,
        'Discovery',
        'RELIABILITY',
    ...
    (
        ...
        102,
        2,
        'Снизить Time-to-Deploy до 15 мин',
        'Ускорить CI/CD пайплайн',
        'P2',
        15,
        'Delivery',
        'EFFICIENCY',
    ...
    (
        ...
        103,
        2,
        'Единая культура инженерного качества',
        'Стандарты кода и процессов для Backend и QA команд',
        'P1',
        100,
        'Discovery',
    ...
    (
        ...
        2,
        'Migrate to Go 1.22',
        'Обновить все сервисы, использовать новые возможности языка',
        'P1',
        50,
        'Delivery',
        'RELIABILITY',
    ...
    (
        ...
        105,
        2,
        'Запустить новую версию API Gateway v2',
        'Рефакторинг маршрутизации, поддержка gRPC',
        'P1',
        70,
        'Delivery',
        'RELIABILITY',
    ...
    (
        ...
        'Покрыть 200 ключевых user flows',
        'P1',
        100,
        'Delivery',
        'QUALITY',
    ...
    (
        ...
        109,
        2,
        '99.9% uptime всех production сервисов',
        'Обеспечить надёжность инфраструктуры',
        'P0',
        60,
        'Delivery',
        'RELIABILITY',
    ...
    (
        ...
        109,
        2,
        'MTTR < 10 мин для P0 инцидентов',
        'Ускорить реакцию на критические сбои',
        'P1',
        40,
        'Delivery',
        'RELIABILITY',
    ...
    (
        ...
        112,
        2,
        'ML-биддинг для топ-10 клиентов',
        '',
        'P1',
        30,
        'Discovery',
...
-- Team-period statuses for the Департамент catalog (period 2 = Y2026)
INSERT INTO
    team_period_statuses (team_id, period_id, status)
VALUES (102, 2, 'in_progress'),
    (103, 2, 'in_progress'),
    (104, 2, 'in_progress'),
    (105, 2, 'forming'),
    (106, 2, 'in_progress'),
...
VALUES
    ...
    (
        ...
        100,
        'P95 latency API gateway',
        'Замеряем по Prometheus, окно 5 минут. Считаем latency на edge-роутах /api/v1/*.',
        40,
        'NUMERICAL',
        1,
        NOW(),
    ...
    (
        ...
        100,
        'P95 latency auth service',
        'Внутренние gRPC-вызовы auth.Verify и auth.Refresh, без учёта таймаутов клиента.',
        40,
        'NUMERICAL',
        2,
        NOW(),
    ...
    (
        ...
        100,
        'Миграция на HTTP/2',
        'Все внешние эндпоинты переведены на HTTP/2 с поддержкой fallback на HTTP/1.1.',
        20,
        'PROJECT',
        3,
        NOW(),
    ...
    (
        103,
        101,
        'Unit test coverage CoreDEV',
        'Покрытие по go test -cover для пакетов core/*, без учёта моков и сгенерированного кода. Цель в 80% относится только к бизнес-логике.',
        50,
        'NUMERICAL',
        1,
        NOW(),
    ...
    (
        ...
        'ADR в репозитории docs/adr/, минимум 15 ключевых решений за квартал.',
        60,
        'NUMERICAL',
        1,
        NOW(),
    ...
    (
        110,
        104,
        'Engineering handbook опубликован',
        '',
        50,
        'BOOLEAN',
        1,
    ...
    (
        ...
        'go.mod указывает Go 1.22, CI зелёный, прод-сборка прошла smoke-тесты.',
        60,
        'NUMERICAL',
        1,
        NOW(),
    ...
    (
        117,
        107,
        'Выдерживаемая нагрузка gateway',
        'Нагрузочный тест k6, рост RPS. Прогресс по промежуточным значениям.',
        60,
        'NUMERICAL',
        2,
        NOW(),
    ...
    (
        119,
        109,
        'User flows покрыты авто-тестами',
        '',
        70,
        'NUMERICAL',
        1,
...
FROM (
        VALUES (
            ...
            ), (103, 0.0, 80.0, 14.0, '%'), (106, 0.0, 100.0, 60.0, '%'), (107, 0.0, 100.0, 10.0, '%'), (108, 48.0, 15.0, 48.0, 'мин'), (111, 8.0, 2.0, 5.0, 'час'), (112, 0.0, 100.0, 65.0, '%'), (113, 0.0, 100.0, 80.0, '%'), (
                117, 100.0, 180.0, 170.0, 'RPS'
            ), (119, 0.0, 200.0, 76.0, 'шт'), (121, 0.0, 80.0, 44.0, '%'), (122, 97.0, 99.5, 98.6, '%'), (123, 98.0, 99.9, 99.2, '%'), (124, 98.0, 99.9, 99.4, '%'), (125, 0.0, 90.0, 41.0, '%'), (127, 35.0, 10.0, 20.0, 'мин'), (130, 100.0, 85.0, 97.0, '%'), (132, 0.0, 10.0, 2.0, '%')
    ) AS v (
        kr_id, start, target, current, unit
    )
WHERE
...
UPDATE key_results
SET
    checkpoints = '[{"value":100,"progress_percent":0},{"value":150,"progress_percent":50},{"value":180,"progress_percent":100}]'::jsonb
WHERE
    id = 117;

UPDATE key_results
SET
    checkpoints = '[{"value":50,"progress_percent":25},{"value":100,"progress_percent":50},{"value":150,"progress_percent":75},{"value":200,"progress_percent":100}]'::jsonb
WHERE
    id = 119;
...
UPDATE key_results
SET
    zeroing_criteria = 'Если латентность достигнута только за счёт отключения проверок безопасности на edge — результат не засчитывается.'
WHERE
    id = 100;

UPDATE key_results
SET
    zeroing_criteria = 'Если хотя бы один внешний эндпоинт откатили обратно на HTTP/1.1 из-за инцидента в проде — результат не засчитывается.'
WHERE
    id = 102;
...
VALUES (
        100,
        100,
        'Начали профилирование. Нашли узкое место в middleware auth.',
        1,
        NOW()
    ),
    (
        101,
        100,
        'Нужно учесть зависимость от PaaS/Infra по HTTP/2-конфигурации nginx.',
        1,
        NOW()
    ),
    (
        102,
        102,
        'ADR по 12 ключевым решениям готовы. Миграция API docs с Confluence в процессе.',
        1,
        NOW()
    ),
    (
        103,
        105,
        'Осталось 3 сервиса. Основные проблемы с устаревшими зависимостями решены.',
        1,
        NOW()
    ),
    (
        104,
        112,
        'Апрельский инцидент устранён. Добавили circuit breaker на 3 критичных точках.',
        1,
        NOW()
    );
...
VALUES (
        ...
        100,
        100,
        'Согласовали с Infra: HTTP/2 включаем на следующей неделе.',
        1,
        NOW()
    ),
    (
        ...
        100,
        101,
        'Уточнил у PaaS — конфиг nginx поправят в этом спринте.',
        1,
        NOW()
    );
...
VALUES (
        101,
        'Нашли узкое место в JWT verify — пул соединений был слишком мал.',
        1,
        NOW()
    ),
    (
        104,
        'Ожидаем инфраструктуру от PaaS — блокер на неделю.',
        1,
        NOW()
    ),
    (
        112,
        'Осталось 3 сервиса. Проблемы с устаревшими зависимостями решены.',
        1,
        NOW()
    );

-- ----------------------------------------------------------------
-- Goal links (декомпозиция «дочерняя → родительская»).
-- Родители — годовые цели Y2026 (period 2), потомки — квартальные цели
-- Q3 · 2026 (period 4) и Q1 · 2026 (period 1). Связь не делает цель общей
-- и не влияет на прогресс: это только дерево декомпозиции для /goal-tree.
-- ----------------------------------------------------------------
INSERT INTO
    goal_links (
        tenant_id,
...
VALUES
    -- 112 «99.9% uptime всех production сервисов» (SRE, Y2026)
    (1, 8, 112),
    (1, 9, 112),
    -- 113 «MTTR < 10 мин для P0 инцидентов» (SRE, Y2026)
    (1, 10, 113),
    (1, 38, 113),
    -- 110 «Перевести 80% сервисов на k8s» (PaaS / Infra, Y2026) —
    -- годовая цель одной команды раскладывается в квартальную цель соседней
    (1, 37, 110),
    -- 114 «DWH для метрик» (DWH, Y2026)
    (1, 35, 114),
    (1, 36, 114);
...
VALUES
    ...
    (
        ...
        9,
        NULL,
        'Календарь дежурств внедрен в 5 команд',
        '{"before":{"progress":40},"after":{"progress":65},"kind":"NUMERICAL"}',
    ...
    (
        ...
        5,
        'Снизить P95 latency до 200ms',
        '{"text":"Обновление по задаче выполнено."}',
    ...
    (
        ...
        NULL,
        'PaaS / Infra',
        '{"before":{"status":"forming"},"after":{"status":"in_progress"}}',
    ...
    (
        ...
        7,
        'Внедрить IaC для всей инфраструктуры',
        '{"before":{"resolved":false},"after":{"resolved":true}}',
        NOW() - INTERVAL '3 days'
    ),
    (
        1,
    ...
    (
        ...
        NULL,
        'Сократить MTTR до 30 минут',
        '{"changed":{"title":{"before":"Сократить MTTR","after":"Сократить MTTR до 30 минут"}}}',
        NOW() - INTERVAL '6 days'
    ),
    (
        1,
        ...
        NULL,
        'Обеспечить 99.9% uptime DWH пайплайнов',
        '{"before":{"progress":80},"after":{"progress":100},"kind":"NUMERICAL"}',
...
FROM users u
WHERE
    u.provider_subject_key = 'system:migration'
ON CONFLICT DO NOTHING;
